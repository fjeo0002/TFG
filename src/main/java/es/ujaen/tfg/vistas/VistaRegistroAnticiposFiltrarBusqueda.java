...
public class VistaRegistroAnticiposFiltrarBusqueda extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaRegistroAnticiposFiltrarBusqueda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VistaRegistroAnticiposFiltrarBusqueda dialog = new VistaRegistroAnticiposFiltrarBusqueda(new javax.swing.JFrame(), true);
